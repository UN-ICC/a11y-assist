(function () {
  ...
  function renderVerify() {
    main.innerHTML = '<section class="tab-intro"><h2>Verify</h2>'
      + '<p>Paste an HTML snippet and run <a href="https://github.com/dequelabs/axe-core" target="_blank" rel="noreferrer">axe-core</a> in your browser to check it against WCAG at the selected level. This covers only the structurally testable criteria — a slice of WCAG, not half. Qualitative criteria (screen-reader output, focus visibility, meaningful labels) and dynamic behaviour require human review.</p></section>'
      + '<div class="pane">'
  ...
  async function runVerify() {
    ...
    try {
      ...
      out.innerHTML = (vs.length === 0
        ...
        + '<p class="note">axe covers only the structurally testable slice of WCAG. Manual screen-reader, keyboard, and cognitive review still required.</p>'
    } catch (e) {
