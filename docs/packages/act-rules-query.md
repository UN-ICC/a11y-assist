---
title: act-rules-query
parent: Packages
nav_order: 3
permalink: /packages/act-rules-query/
---
...
- [`apg-query`](/a11y-assist/packages/apg-query/) — APG patterns
- [`wcag-query`](/a11y-assist/packages/wcag-query/) — WCAG 2.2 SCs + Techniques + Failures
